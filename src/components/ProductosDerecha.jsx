...
export default function Productos (props) {
    return (
        <div className="h-full w-5/6 m-0 flex flex-col lg:flex-row items-center justify-center ">
            <div className='w-4/6 lg:w-1/2 min-w-min h-auto'>
            ...
            <motion.img className='w-4/6 lg:w-1/2 h-full' src={props.img} alt="" initial={{x:+500}} animate={{x:0}} transition={{duration: 2}} viewport={{once: true}} whileInView={{x:0}} />
        </div>
    )
}
